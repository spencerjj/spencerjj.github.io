  ...
  onLoad: function (options) {
    var that = this;
      ...
      wx.setNavigationBarTitle({
        title: userDetails.managername+'的标签'
      })
      that.setData({
        imgPath:path,
  ...
  add(e){
    ...
    if(that.data.myTag.length>0){
      ...
      wx.request({
        ...
        method: 'post',
        data: {
          userCode:that.data.userDetails.managerid,
          username:that.data.userDetails.managername,
  ...
  getTag(e){
    ...
    wx.request({
      ...
      data: {
        ...
        __ajax:'json',
        empCode:that.data.userDetails.managerid
      },
      header: {
